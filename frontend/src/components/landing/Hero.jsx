    ...
    <section className="hero">
      ...
      <div className="container hero-layout">
        <div className="hero-text">
          ...
          <h1>On-Demand<br /><span className="hero-blue">Maintenance</span> for<br />Homes &amp; Businesses</h1>
          ...
          <div className="hero-btns" style={{ marginTop: "32px", display: "flex", gap: "16px" }}>
            <a href="#" className="btn-primary-lg" style={{ padding: "14px 32px", borderRadius: "30px" }}>Book a Service</a>
            <a href="#how-it-works" className="btn-outline-lg" style={{ padding: "14px 32px", borderRadius: "30px", borderColor: "rgba(255,255,255,0.3)", color: "#fff" }}>
              How it Works
            </a>
          </div>
          <div className="hero-trust" style={{ marginTop: "40px", display: "flex", gap: "24px", color: "#94a3b8", fontSize: "0.85rem" }}>
        ...
        <div className="hero-visual">
          <div className="mockup-card glass-panel floating">
            ...
            <div className="mockup-pro-strip">
              ...
              <div className="mock-pro-mid">
                ...
                <div className="pro-r"><span style={{ color: "#f5a623" }}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> 4.9</div>
              </div>
            ...
            <div className="mockup-map-container dark-map">
              <div className="map-placeholder">
                <svg className="route-line" preserveAspectRatio="none" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
                  <path d="M 20 80 L 40 70 L 60 90 L 80 85 L 120 60 L 140 60" fill="none" stroke="#2563eb" strokeWidth="2.5" />
                  <path d="M 20 80 L 40 70 L 60 90 L 80 85 L 120 60 L 140 60" fill="none" stroke="#60a5fa" strokeWidth="1" filter="blur(2px)" />
                  <path d="M 140 60 C 150 50, 160 30, 180 20" fill="none" stroke="#e2e8f0" strokeWidth="1.5" strokeDasharray="4,4" />
                </svg>
                <div className="map-eta-badge">20 min</div>
            ...
            <div className="mockup-progress tracker-line">
              <div className="progress-steps text-xs">
          ...
          <div className="float-stat glass-float stat-top-left floating-slow">
            <div style={{ fontSize: "10px", color: "#cbd5e1" }}>Active Providers</div>
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#fff", margin: "2px 0" }}>200+</div>
            <div style={{ fontSize: "11px", color: "#00e880", fontWeight: "600" }}>Nearby</div>
          </div>

          <div className="float-stat glass-float stat-bottom-right floating-slower">
            <div style={{ fontSize: "10px", color: "#cbd5e1" }}>Service Done</div>
            <div style={{ fontSize: "20px", fontWeight: "700", color: "#fff", margin: "2px 0" }}>40K+</div>
